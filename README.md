...
## AI Governance, Adversarial Assurance, and Security Risk

I build evidence-centered governance and assurance methods for high-consequence
AI, cybersecurity, security, and investigative decisions. My work combines Red
Team methodology, multi-model evaluation, control frameworks, legal analysis,
...
- Adversarial testing and AI output assurance
- Cybersecurity governance, risk, and compliance
- Human oversight, auditability, and defensible decision records
- Protective intelligence and complex investigations
...
> AI agreement is not the same as truth. High-consequence outputs require
> evidence, adversarial challenge, preserved dissent, and accountable human
> judgment.

Connect with me on [LinkedIn](https://www.linkedin.com/in/majorvandenhouten/).
